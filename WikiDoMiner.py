...
def main():
    ...
    parser.add_argument('--title-similarity', dest='title_similarity', type=bool, default=True, help='filter using similarity between the keywords and the matching titles')
    ...
    parser.add_argument('--wiki-auto-suggest', dest='auto_suggest', type=bool, default=True, help='allow auto suggest from wikipedia if the keyword doesn\'t match any article')
