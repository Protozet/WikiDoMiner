...
directory = 'requirements_2' # Folder name with requirement specification PDFs
...
keywords = kw_model.extract_keywords(lst, keyphrase_ngram_range=(1, 1), 
...
for a in keywords:
     for b in a:
           ...
           for title in matching_titles[0]:
                if calculate_jaccard(title,keyword)<0.5:
                    continue
